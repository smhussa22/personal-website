...
export default function Personal() {
  return (
    ...
    >
          ...
          {PROJECTS.map((project) => (
            <div key={project.id} className="space-y-2">
              <div className="relative rounded-2xl bg-zinc-50/40 p-1 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-950/40 dark:ring-zinc-800/50">
                <div className="relative h-[240px] w-full rounded-xl bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center">
                  <Image
      ...
      {/* Recently Section (2 Images Only) */}
      <motion.section variants={VARIANTS_SECTION} transition={TRANSITION_SECTION}>
        <h3 className="mb-5 text-lg font-medium">Recently..</h3>

        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          
          {/* Picture 1 - Slight Zoom Fill */}
<div className="relative rounded-2xl bg-zinc-50/40 p-1 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-950/40 dark:ring-zinc-800/50">
